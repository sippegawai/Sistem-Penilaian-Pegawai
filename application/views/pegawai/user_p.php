      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-12 text-center">
            <h2 class="section-title mb-3">Data Buruh</h2>
          </div>
        </div>
      </div>
      <div class="container">
            ...
            <table  class="table table-striped table-bordered table-sm">
              ...
              <?php
                $no = 1;
                foreach ($buruh as $bur) :
              ?>
              <tr>
                <td><?php echo $no++;?></td>
                <td><?php echo $bur->nik;?></td>
                <td><?php echo $bur->nama;?></td>
                <td><div onclick="javascript: return confirm('Anda yakin ingin menghapus data ini ?')"><?php echo anchor('user_peg/hapus/'.$bur->id,('<div class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></div>'));?></div></td>
              </tr>
              <?php endforeach; ?>
            </table>
      </div>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form method="post" action="<?php echo base_url('user_peg/tambah_buruh'); ?>">
